...
//функция открытия модального окна при клике на card статический
...
//функция открытия модального окна при клике на card динамический
bindModal(videos);
...
// работа с youtube API - набор какой-то информации и набор каких-то действий, которые мы можем совершать
